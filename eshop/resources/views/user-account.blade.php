    ...
    <main class="container py-4">
        ...
        <div class="row justify-content-center g-3">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <form class="p-4 bg-light border rounded h-100" action="{{ route('account.update') }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <input id="last-name" name="last_name" type="text" class="form-control"
                            value="{{ old('last_name', $userInfo->last_name ?? '') }}" required>
                        @error('last_name')
                        <div class="text-danger small">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="p-4 bg-light border rounded h-100 d-flex flex-column">
                    ...
                    <form action="#" method="POST" class="mb-auto">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="new-password" name="password" type="password" class="form-control" required>
                        </div>
